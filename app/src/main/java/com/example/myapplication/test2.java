...
public class test2 extends AppCompatActivity implements View.OnClickListener {
    ...
    void loadNewQuestion() {
        ...
        ans1.setText(QuestionAnswer2.choices[currentQuestionIndex][0]);
        ans2.setText(QuestionAnswer2.choices[currentQuestionIndex][1]);
        ans3.setText(QuestionAnswer2.choices[currentQuestionIndex][2]);
