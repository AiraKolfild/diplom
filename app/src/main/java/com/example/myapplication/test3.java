...
public class test3 extends AppCompatActivity implements View.OnClickListener {
    ...
    int score = 0;
    int totalQuestions = QuestionAnswer3.question.length;
    ...
    void loadNewQuestion() {
        ...
        questionsTextView.setText(QuestionAnswer3.question[currentQuestionIndex]);
        ans1.setText(QuestionAnswer3.choices[currentQuestionIndex][0]);
        ans2.setText(QuestionAnswer3.choices[currentQuestionIndex][1]);
        ans3.setText(QuestionAnswer3.choices[currentQuestionIndex][2]);
